...
Generated on Wed, 7 Jul 2021 00:38:14
...
* URL: [https://api.gouv.fr/equipe](https://api.gouv.fr/equipe)
  ...
  * Evidence: `993f-qtyew9ROekpKecLohCKlk2RTIkQ`
...
* URL: [https://api.gouv.fr/mentions-legales](https://api.gouv.fr/mentions-legales)
  ...
  * Evidence: `5fc6-ysF4/9zr/8l3NipybLSYqDHdgyo`
...
* URL: [https://api.gouv.fr/contact](https://api.gouv.fr/contact)
  ...
  * Evidence: `6eb8-HCP3p3Jw/vfBdufSYlrhJctt/CQ`
...
* URL: [https://api.gouv.fr/feuille-de-route](https://api.gouv.fr/feuille-de-route)
  ...
  * Evidence: `a64b-4seIujD5UEivXPaKa6nzMgKtvl0`
...
* URL: [https://api.gouv.fr/services](https://api.gouv.fr/services)
  ...
  * Evidence: `f3e9-5Bcx5fNpS7V7+rl3xkuF2Tja/DA`
...
* URL: [https://api.gouv.fr](https://api.gouv.fr)
  ...
  * Evidence: `ceec-zB25OWxEDgLqh1wZWC2ICKC4hIs`
...
* URL: [https://api.gouv.fr/apropos](https://api.gouv.fr/apropos)
  ...
  * Evidence: `770e-gk34jbtLjrQqQ/FIRhfTEChXpqw`
...
### Other information
<p>�����r{\x000fQ9�))�\x000b�\x0010��M�L�\x0010</p>
...
### Other information
<p>The following pattern was used: \bQUERY\b and was detected in the element starting with: "<script id="__NEXT_DATA__" type="application/json">{"props":{"pageProps":{"apis":[{"title":"API Indemnités Journalières de la CN", see evidence field for the suspicious comment/snippet.</p>
