...
Generated on Mon, 20 Sep 2021 23:09:16
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/sign_up?structure_id=58a5e24c-2a68-42a8-9b2c-d021211454b1](https://api.app.eva.beta.gouv.fr/admin/sign_up?structure_id=58a5e24c-2a68-42a8-9b2c-d021211454b1)
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/password](https://api.app.eva.beta.gouv.fr/admin/password)
...
* URL: [https://api.app.eva.beta.gouv.fr/structures](https://api.app.eva.beta.gouv.fr/structures)
...
* URL: [https://api.app.eva.beta.gouv.fr/structures?code_postal=ZAP&commit=chercher](https://api.app.eva.beta.gouv.fr/structures?code_postal=ZAP&commit=chercher)
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/password/new](https://api.app.eva.beta.gouv.fr/admin/password/new)
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/login](https://api.app.eva.beta.gouv.fr/admin/login)
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/sign_up?structure_id=40832e76-b3e4-4c54-8f12-fa2e3168cd03](https://api.app.eva.beta.gouv.fr/admin/sign_up?structure_id=40832e76-b3e4-4c54-8f12-fa2e3168cd03)
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/sign_up?structure_id=7e85d45c-901e-48e5-999f-9a6469ab1438](https://api.app.eva.beta.gouv.fr/admin/sign_up?structure_id=7e85d45c-901e-48e5-999f-9a6469ab1438)
...
* URL: [https://api.app.eva.beta.gouv.fr/assets/active_admin-67976549d8226a93402e09dce77ba2e6c8c215f1c87a3302793d66b5d60a7b47.js](https://api.app.eva.beta.gouv.fr/assets/active_admin-67976549d8226a93402e09dce77ba2e6c8c215f1c87a3302793d66b5d60a7b47.js)
...
* URL: [https://api.app.eva.beta.gouv.fr/structures](https://api.app.eva.beta.gouv.fr/structures)
  ...
  * Evidence: `<form action="/structures" accept-charset="UTF-8" method="get">`
...
* URL: [https://api.app.eva.beta.gouv.fr/assets/active_admin-8bb67b0af2b167df544b11186407a70ef9d699be1f0db359e8ac3afb856e40a3.css](https://api.app.eva.beta.gouv.fr/assets/active_admin-8bb67b0af2b167df544b11186407a70ef9d699be1f0db359e8ac3afb856e40a3.css)
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/login](https://api.app.eva.beta.gouv.fr/admin/login)
  ...
  * Evidence: `pojtVPpO-84VjJdUqBn9jE75qdDBuPEK7GRZjT95crw99CE74SJUwouGbwWbfSdALuh80t5tzEKzepwzJI2PRg`
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/password/new](https://api.app.eva.beta.gouv.fr/admin/password/new)
  ...
  * Evidence: `2FrxutHzntaPwrB1wIU4nQXAgEiciOj`
...
* URL: [https://api.app.eva.beta.gouv.fr/structures?code_postal=ZAP&commit=chercher](https://api.app.eva.beta.gouv.fr/structures?code_postal=ZAP&commit=chercher)
  ...
  * Evidence: `2BGBfbnqfVZ0IzzugE1jjt3wnPDnm0hGLck`
...
* URL: [https://api.app.eva.beta.gouv.fr/structures](https://api.app.eva.beta.gouv.fr/structures)
  ...
  * Evidence: `2FjSbrvrBXj0DQdF6XCmt0xRm8gOvx4leaMSCGiNsaEhx0E8QbJ83d1NACxKR9dP`
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/login](https://api.app.eva.beta.gouv.fr/admin/login)
  ...
  * Evidence: `htVKcXDNdvszE798ZKf3JBLYVWFWH0zQ5DxnEhp`
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/login](https://api.app.eva.beta.gouv.fr/admin/login)
  ...
  * Evidence: `2BZPfNqAg9n81HAUq1hCdx3mU08JOTjEJ5S5TjJQrJK1BTHNpmb7LerMqPG9Z9moWKX0l81Pl4mRUYdryn7dvePG`
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/password](https://api.app.eva.beta.gouv.fr/admin/password)
  ...
  * Evidence: `2FyURjUlxZRND8p6N7jyxIreWFc7yqtGe7fNVC8me8OyHGPNWGh`
...
### Other information
<p>���T�N��\x0015��T�\x0019��N������</p><p>�dY�?yr�=�!;�"T�o\x0005�}'@.�|��m�B�z�3$��F</p>
...
* URL: [https://api.app.eva.beta.gouv.fr/admin/dashboard](https://api.app.eva.beta.gouv.fr/admin/dashboard)
...
* URL: [https://api.app.eva.beta.gouv.fr/admin](https://api.app.eva.beta.gouv.fr/admin)
...
### Other information
<p>User-controlled HTML attribute values were found. Try injecting special characters to see if XSS might be possible. The page at the following URL:</p><p></p><p>https://api.app.eva.beta.gouv.fr/admin/password</p><p></p><p>appears to include user input in: </p><p></p><p>a(n) [input] tag [value] attribute </p><p></p><p>The user input found was:</p><p>commit=Réinitialiser mon mot de passe</p><p></p><p>The user-controlled value was:</p><p>réinitialiser mon mot de passe</p>
