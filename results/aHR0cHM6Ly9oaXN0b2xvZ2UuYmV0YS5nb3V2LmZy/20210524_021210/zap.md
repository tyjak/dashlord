...
Generated on Mon, 24 May 2021 02:04:35
...
### Other information
<p>No known Anti-CSRF token [anticsrf, CSRFToken, __RequestVerificationToken, csrfmiddlewaretoken, authenticity_token, OWASP_CSRFTOKEN, anoncsrf, csrf_token, _csrf, _csrfSecret, __csrf_magic, CSRF] was found in the following HTML form: [Form 1: "txtName" "txtEmail" "recaptchaResponse" ].</p>
...
* URL: [http://histologe.beta.gouv.fr/dev/include/plotly-latest.min.js](http://histologe.beta.gouv.fr/dev/include/plotly-latest.min.js)
...
### Other information
<p>The following pattern was used: \bSELECT\b and was detected in the element starting with: "!function(){"use strict";var t=window.dsfr||{core:{}};window.dsfr=t;var e=function(t){return"rf-"+t};e.selector=function(t,i){re", see evidence field for the suspicious comment/snippet.</p>
